...
import bookDashed from './book-dashed.svelte';
import bookDown from './book-down.svelte';
import bookHeadphones from './book-headphones.svelte';
import bookHeart from './book-heart.svelte';
...
import cameraOff from './camera-off.svelte';
import candyOff from './candy-off.svelte';
...
import circleArrowLeft from './circle-arrow-left.svelte';
import circleArrowOutDownLeft from './circle-arrow-out-down-left.svelte';
import circleArrowOutDownRight from './circle-arrow-out-down-right.svelte';
import circleArrowOutUpLeft from './circle-arrow-out-up-left.svelte';
...
import clock12 from './clock-12.svelte';
import clock2 from './clock-2.svelte';
import clock3 from './clock-3.svelte';
import clock4 from './clock-4.svelte';
import clock5 from './clock-5.svelte';
import clock6 from './clock-6.svelte';
...
import dice1 from './dice-1.svelte';
import dice2 from './dice-2.svelte';
import dice3 from './dice-3.svelte';
import dice4 from './dice-4.svelte';
import dice5 from './dice-5.svelte';
import dice6 from './dice-6.svelte';
...
import flaskConicalOff from './flask-conical-off.svelte';
import folderCheck from './folder-check.svelte';
import folderCog from './folder-cog.svelte';
import folderDown from './folder-down.svelte';
import folderKanban from './folder-kanban.svelte';
import folderPen from './folder-pen.svelte';
import folderPlus from './folder-plus.svelte';
...
import monitorDown from './monitor-down.svelte';
...
import notebookPen from './notebook-pen.svelte';
import nutOff from './nut-off.svelte';
...
import squareChevronUp from './square-chevron-up.svelte';
import squareDashedKanban from './square-dashed-kanban.svelte';
import squareKanban from './square-kanban.svelte';
import squareParkingOff from './square-parking-off.svelte';
import squarePen from './square-pen.svelte';
import squarePlus from './square-plus.svelte';
...
import washingMachine from './washing-machine.svelte';
